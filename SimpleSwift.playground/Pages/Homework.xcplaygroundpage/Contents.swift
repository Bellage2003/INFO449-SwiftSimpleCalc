...
func calculate(_ args: [String]) -> Int {
    if args.count == 3, 
        let num1 = Int(args[0]), let num2 = Int(args[2]) {
        switch args[1] {
        case "+":
            return num1 + num2
        case "-":
        ...
        case "count":
            return args.count - 1
        case "avg":
            let nums = args[0..<args.count-1].compactMap { Int($0) }
...
func calculate(_ arg: String) -> Int {
    // convert substring to string in a array
...
func calculate(_ args: [String]) -> Double {
    if args.count == 3, 
        let num1 = Double(args[0]), let num2 = Double(args[2]) {
        switch args[1] {
        case "+":
            return num1 + num2
        case "-":
